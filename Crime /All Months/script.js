...
const data_url =
  "https://api.mapbox.com/datasets/v1/devupreti/cm6oyuiizbq831orx386q8p71/features?access_token=pk.eyJ1IjoiZGV2dXByZXRpIiwiYSI6ImNtNXdjZjlxaDAxZ24yanNneGF2Y2g1ZGMifQ.Ouc9ZSrfNJLKzs0ykgSFqA";
map.on("load", () => {
  map.addLayer({
    id: "crimes",
    type: "circle",
